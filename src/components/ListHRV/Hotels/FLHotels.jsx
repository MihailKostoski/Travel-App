      ...
      <div
        className={`${
          filteredList.length > 0
            ? "flex flex-col h-full gap-5  w-[400px] sm:w-[440px]  md:w-[580px] lg:w-[720px] "
            : "hidden"
        }`}
      >
        {arrayConcated?.map((hotelItem) => (
          <div
            className="flex flex-col items-start gap-5 w-full md:flex-row justify-center items-center"
            key={hotelItem.id}
          >
            <div className="relative w-[400px]">
              <div className="flex justify-between absolute top left w-[340px] h-full">
                <button
                  onClick={() => {
            ...
            <div
              ...
              whitespace-normal flex flex-col items-start"
            >
              <span
                className=""
